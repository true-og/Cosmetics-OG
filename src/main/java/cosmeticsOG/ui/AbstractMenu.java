...
public abstract class AbstractMenu {
    ...
    protected static final MenuAction emptyAction = (event, slot) -> {
    ...
    public AbstractMenu(final CosmeticsOG core, final MenuManager menuManager, final Player owner) {
        ...
        this.mainMenuButtonItem = ItemUtil.createItem(Material.NETHER_STAR, 1,
                Message.EDITOR_MISC_MAIN_MENU.getValue());
        this.backButtonItem = ItemUtil.createItem(Material.NETHER_STAR, 1, Message.EDITOR_MISC_GO_BACK.getValue());
     ...
     * 
     * @param forced True if this menu is being closed without the players
     *               involvement
     */
