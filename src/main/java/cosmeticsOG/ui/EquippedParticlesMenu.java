...
public class EquippedParticlesMenu extends AbstractListMenu {
	...
	private final ItemStack emptyItem = ItemUtil.createItem(CompatibleMaterial.BARRIER.getMaterial(), 1, Message.ACTIVE_PARTICLES_EMPTY.getValue());
	...
	public EquippedParticlesMenu(CosmeticsOG core, MenuManager menuManager, Player owner, boolean fromMenu) {
		...
		this.setMenu(0, Bukkit.createInventory(null, 54, Utils.legacySerializerAnyCase(Message.ACTIVE_PARTICLES_MENU_TITLE.getValue())));
