package cosmeticsOG.API;

import cosmeticsOG.CosmeticsOG;
import cosmeticsOG.database.Database;
import cosmeticsOG.exceptions.InvalidLabelException;
...
public class HatAPI extends ParticleHatsAPI {
    ...
    public HatAPI(final CosmeticsOG core) {
    ...
    @Override
    public void equipHatFromLabel(Player player, String label, boolean tellPlayer, boolean permanent)
            throws InvalidLabelException, IllegalArgumentException
    {
    ...
    @Override
    public void equipHatFromLabel(Player player, String label, boolean tellPlayer)
            throws InvalidLabelException, IllegalArgumentException
    {
