...
public enum Message {
    ...
    PARTICLE_SOUL_FIRE_FLAME_DESCRIPTION("&8Blue version of the &bFlame &8particle"),
    PARTICLE_ASH_NAME("&bAsh"),
    PARTICLE_ASH_DESCRIPTION(""),
    PARTICLE_CRIMSON_SPORE_NAME("&bCrimson Spore"),
    PARTICLE_CRIMSON_SPORE_DESCRIPTION(""),
    PARTICLE_WARPED_SPORE_NAME("&bWarped Spore"),
    PARTICLE_WARPED_SPORE_DESCRIPTION(""),
    PARTICLE_SOUL_NAME("&bSoul"),
    PARTICLE_SOUL_DESCRIPTION(""),
    PARTICLE_DRIPPING_OBSIDIAN_TEAR_NAME("&bDripping Obsidian Tear"),
    PARTICLE_DRIPPING_OBSIDIAN_TEAR_DESCRIPTION(""),
    PARTICLE_FALLING_OBSIDIAN_TEAR_NAME("&bFalling Obsidian Tear"),
    PARTICLE_FALLING_OBSIDIAN_TEAR_DESCRIPTION(""),
    PARTICLE_LANDING_OBSIDIAN_TEAR_NAME("&bLanding Obsidian Tear"),
    PARTICLE_LANDING_OBSIDIAN_TEAR_DESCRIPTION(""),
    PARTICLE_REVERSE_PORTAL_NAME("&bReverse Portal"),
    ...
    PARTICLE_SONIC_BOOM_NAME,
    PARTICLE_SONIC_BOOM_DESCRIPTION,
    PARTICLE_SCULK_SOUL_NAME,
    PARTICLE_SCULK_SOUL_DESCRIPTION,
    PARTICLE_SCULK_CHARGE_NAME,
    PARTICLE_SCULK_CHARGE_DESCRIPTION,
    PARTICLE_SCULK_CHARGE_POP_NAME,
    PARTICLE_SCULK_CHARGE_POP_DESCRIPTION,
    PARTICLE_SHRIEK_NAME,
    PARTICLE_SHRIEK_DESCRIPTION,
    PARTICLE_CHERRY_LEAVES_NAME,
    PARTICLE_CHERRY_LEAVES_DESCRIPTION,
    PARTICLE_ENTITY_EFFECT_NAME,
    PARTICLE_ENTITY_EFFECT_DESCRIPTION,
    PARTICLE_EGG_CRACK_NAME,
    PARTICLE_EGG_CRACK_DESCRIPTION,
    PARTICLE_DUST_PLUME_NAME,
    PARTICLE_DUST_PLUME_DESCRIPTION,
    PARTICLE_WHITE_SMOKE_NAME,
    PARTICLE_WHITE_SMOKE_DESCRIPTION,
    PARTICLE_GUST_NAME,
    PARTICLE_GUST_DESCRIPTION,
    PARTICLE_SMALL_GUST_NAME,
    PARTICLE_SMALL_GUST_DESCRIPTION,
    PARTICLE_GUST_EMITTER_LARGE_NAME,
    PARTICLE_GUST_EMITTER_LARGE_DESCRIPTION,
    PARTICLE_GUST_EMITTER_SMALL_NAME,
    PARTICLE_GUST_EMITTER_SMALL_DESCRIPTION,
    PARTICLE_TRIAL_SPAWNER_DETECTION_NAME,
    PARTICLE_TRIAL_SPAWNER_DETECTION_DESCRIPTION,
    PARTICLE_TRIAL_SPAWNER_DETECTION_OMINOUS_NAME,
    PARTICLE_TRIAL_SPAWNER_DETECTION_OMINOUS_DESCRIPTION,
    PARTICLE_VAULT_CONNECTION_NAME,
    PARTICLE_VAULT_CONNECTION_DESCRIPTION,
    PARTICLE_INFESTED_NAME,
    PARTICLE_INFESTED_DESCRIPTION,
    PARTICLE_ITEM_COBWEB_NAME,
    PARTICLE_ITEM_COBWEB_DESCRIPTION,
    PARTICLE_DUST_PILLAR_NAME,
    PARTICLE_DUST_PILLAR_DESCRIPTION,
    PARTICLE_OMINOUS_SPAWNING_NAME,
    PARTICLE_OMINOUS_SPAWNING_DESCRIPTION,
    PARTICLE_RAID_OMEN_NAME,
    PARTICLE_RAID_OMEN_DESCRIPTION,
    PARTICLE_TRIAL_OMEN_NAME,
    PARTICLE_TRIAL_OMEN_DESCRIPTION,
    ...
    TYPE_CLEAN_TRAIL_DESCRIPTION(
            "&8A single particle, use it however you want"), // ("&8A lonely particle, can be used/n&8to create complex
    // designs"),
    ...
    EDITOR_TAG_OVERVIEW_MENU_INFO(
            "&8Tags are experimental features/n&8that may, or may not stay/n&8depending on their popularity"), // ("&8Tags are experimental features/n&8that don't quite have/n&8a place of their own yet."),
    ...
    // Color menu.
    EDITOR_COLOUR_MENU_TITLE("Select or Create a Colou"),
    ...
    EDITOR_COLOUR_MENU_SET_RANDOM("&bRandom Colors"),
