...
import cosmeticsOG.editor.menus.EditorMainMenu;
import cosmeticsOG.editor.menus.EditorSettingsMenu;
...
public class EditorMenuManager extends MenuManager {
    ...
    public EditorMenuManager(CosmeticsOG core, Player owner) {
        super(core, owner);
