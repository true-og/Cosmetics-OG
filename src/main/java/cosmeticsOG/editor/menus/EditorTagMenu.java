...
public class EditorTagMenu extends AbstractListMenu {
    ...
    protected void build() {
        ...
        for (ParticleTag tag : ParticleTag.values()) {
            ...
            ItemStack tagItem = ItemUtil.createItem(CompatibleMaterial.MUSHROOM_STEW.getMaterial(),
                    tagTitle.replace("{1}", tag.getDisplayName()), StringUtil.parseDescription(tag.getDescription()));
