...
public class EditorParticleSelectionMenu extends AbstractStaticMenu {
	...
	public EditorParticleSelectionMenu(CosmeticsOG core, EditorMenuManager menuManager, Player owner, int particleIndex, MenuObjectCallback callback) {
		...
		this.recentFilterMenu = Bukkit.createInventory(null, 54, Utils.legacySerializerAnyCase(Message.EDITOR_PARTICLE_MENU_RECENT_FILTER_TITLE.getValue()));
	...
	protected void build() {
		...
		recentFilterMenu.setItem(45, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_NORMAL_FILTER.getValue()));
		recentFilterMenu.setItem(46, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_COLOUR_FILTER.getValue()));
		recentFilterMenu.setItem(47, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_DATA_FILTER.getValue()));
		recentFilterMenu.setItem(53, ItemUtil.createItem(CompatibleMaterial.MUSHROOM_STEW.getMaterial(), 1, Message.EDITOR_PARTICLE_MENU_RECENT_FILTER.getValue()));
	...
	private void generateMenus (Map<Integer, Inventory> pages, Message title, int totalPages, MenuType type) {
		...
		for (int i = 0; i < totalPages; i++) {
			...
			inventory.setItem(45, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_NORMAL_FILTER.getValue()));
			inventory.setItem(46, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_COLOUR_FILTER.getValue()));
			inventory.setItem(47, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_DATA_FILTER.getValue()));
			inventory.setItem(53, ItemUtil.createItem(Material.BOWL, 1, Message.EDITOR_PARTICLE_MENU_RECENT_FILTER.getValue()));

			if ((i + 1) < totalPages) {

				inventory.setItem(50, ItemUtil.createItem(CompatibleMaterial.LIME_DYE.getMaterial(), 1, Message.EDITOR_MISC_NEXT_PAGE.getValue()));

			}

			if ((i + 1) > 1) {

				inventory.setItem(48, ItemUtil.createItem(CompatibleMaterial.LIME_DYE.getMaterial(), 1, Message.EDITOR_MISC_PREVIOUS_PAGE.getValue()));
			...
			case COLOR:
				...
				inventory.setItem(46, ItemUtil.createItem(CompatibleMaterial.MUSHROOM_STEW.getMaterial(), 1, Message.EDITOR_PARTICLE_MENU_COLOUR_FILTER.getValue()));
				break;
			case DATA:

				inventory.setItem(47, ItemUtil.createItem(CompatibleMaterial.MUSHROOM_STEW.getMaterial(), 1, Message.EDITOR_PARTICLE_MENU_DATA_FILTER.getValue()));

				break;
			case RECENTS:

				inventory.setItem(53, ItemUtil.createItem(CompatibleMaterial.MUSHROOM_STEW.getMaterial(), 1, Message.EDITOR_PARTICLE_MENU_RECENT_FILTER.getValue()));

				break;
			default:

				inventory.setItem(45, ItemUtil.createItem(CompatibleMaterial.MUSHROOM_STEW.getMaterial(), 1, Message.EDITOR_PARTICLE_MENU_NORMAL_FILTER.getValue()));
