...
public class EditorSearchMenu extends AbstractListMenu {
	...
	public EditorSearchMenu(CosmeticsOG core, MenuManager menuManager, Player owner, String searchQuery, MenuObjectCallback callback) {
	...
	public void insertEmptyItem () {
		...
		setItem(0, 22, ItemUtil.createItem(CompatibleMaterial.BARRIER.getMaterial(), 1, Message.EDITOR_SEARCH_MENU_NO_RESULTS.getValue()));
