...
public class EditorDurationMenu extends AbstractStaticMenu {
	...
	public EditorDurationMenu(CosmeticsOG core, EditorMenuManager menuManager, Player owner, MenuCallback callback) {
		...
		this.inventory = Bukkit.createInventory(null, 27, Utils.legacySerializerAnyCase(Message.EDITOR_DURATION_MENU_TITLE.getValue()));
	...
	protected void build() {
		...
		ItemStack durationItem = ItemUtil.createItem(Material.MAP, 1, Message.EDITOR_DURATION_MENU_SET_DURATION.getValue());
