...
public class EditorAngleMenu extends AbstractStaticMenu {
	...
	public EditorAngleMenu(CosmeticsOG core, EditorMenuManager menuManager, Player owner, MenuCallback callback) {
		...
		this.inventory = Bukkit.createInventory(null, 27, Utils.legacySerializerAnyCase(Message.EDITOR_ANGLE_MENU_TITLE.getValue()));
	...
	public void build () {
		...
		// X Angle.
		ItemStack xItem = ItemUtil.createItem(CompatibleMaterial.REPEATER.getMaterial(), 1, Message.EDITOR_ANGLE_MENU_SET_ANGLE_X.getValue());
		...
		// Y Angle.
		ItemStack yItem = ItemUtil.createItem(CompatibleMaterial.REPEATER.getMaterial(), 1, Message.EDITOR_ANGLE_MENU_SET_ANGLE_Y.getValue());
		...
		// Z Angle.
		ItemStack zItem = ItemUtil.createItem(CompatibleMaterial.REPEATER.getMaterial(), 1, Message.EDITOR_ANGLE_MENU_SET_ANGLE_Z.getValue());
