...
public class EditorSettingsMenu extends AbstractStaticMenu {
    ...
    public EditorSettingsMenu(CosmeticsOG core, EditorMenuManager menuManager, Player owner,
    ...
    protected void build() {
        ...
        // Set alias.
        ItemStack aliasItem = ItemUtil.createItem(Material.NAME_TAG, 1,
                Message.EDITOR_SETTINGS_MENU_SET_ALIAS.getValue());
        ...
        setButton(29, liveItem, (event, slot) -> {
            ...
            EditorLore.updateBooleanDescription(getItem(29), editorBaseMenu.canUpdate(),
                    Message.EDITOR_SETTINGS_MENU_ANIMATION_DESCRIPTION);
