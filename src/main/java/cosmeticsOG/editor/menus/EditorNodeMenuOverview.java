...
public class EditorNodeMenuOverview extends AbstractListMenu {
    ...
    private final ItemStack emptyItem = ItemUtil.createItem(CompatibleMaterial.BARRIER.getMaterial(), 1,
            Message.EDITOR_NODE_OVERVIEW_MENU_EMPTY.getValue());
    ...
    public EditorNodeMenuOverview(CosmeticsOG core, EditorMenuManager menuManager, Player owner) {
        ...
        setMenu(0, Bukkit.createInventory(null, 54,
                Utils.legacySerializerAnyCase(Message.EDITOR_NODE_OVERVIEW_MENU_TITLE.getValue())));
    ...
    protected void build() {
        ...
        setButton(0, 52, addItem, (event, slot) -> {
            ...
            ItemStack item = ItemUtil.createItem(Material.LEATHER_HELMET, title,
