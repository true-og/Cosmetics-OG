...
public class EditorLore {
    ...
    public static void updateTypeDescription(ItemStack item, Hat hat) {
        ...
        if (type.isCustom()) {
            ...
            if (customEffect != null) {
                custom = typeInfo[1]
                        + Message.EDITOR_TYPE_MENU_TYPE_PREFIX
                                .getValue()
                                .replace(
                                        "{1}",
                                        StringUtil.capitalizeFirstLetter(
                                                customEffect.getImageName().toLowerCase()));
            } else {
    ...
    public static void updateLocationDescription(ItemStack item, ParticleLocation location, Message description) {
        ...
        String s = description
                ...
                .replace(
                        "{1}",
                        ParticleLocation.fromId(MathUtil.wrap(id - 1, length, 0))
                                .getDisplayName())
    ...
    public static void updateDisplayModeDescription(ItemStack item, IconDisplayMode displayMode, Message description) {
        ...
        String s = description
                ...
                .replace(
                        "{1}",
                        IconDisplayMode.fromId(MathUtil.wrap(id - 1, length, 0)).getDisplayName())
    ...
    public static void updateSoundItemDescription(ItemStack item, Hat hat) {
        ...
        String soundName =
                !nullSound ? StringUtil.capitalizeFirstLetter(sound.toString().toLowerCase()) : soundInfo[1];
        String clear = !nullSound ? clearInfo[1] : "";

        String s = description
                .replace(soundInfo[0], soundName)
     ...
     * @param argument
     */
    public static void updateSpecificActionDescription(
            ItemStack item, Hat hat, ParticleAction action, String argument) {
        ...
        description =
                description.replace("{1}", actionDescription).replace(dataInfo[0], action.hasData() ? dataInfo[1] : "");
    ...
    private static String getParsedActionDescription(Hat hat, ParticleAction action, String argument) {
        switch (action) {
            ...
            case OPEN_MENU: {
                ...
                description =
                        description.replace("{1}", action.getStrippedName()).replace(menuInfo[0], menu);
            ...
            case COMMAND: {
                ...
                description =
                        description.replace("{1}", action.getStrippedName()).replace(commandInfo[0], command);
    ...
    public static void updateTrackingDescription(ItemStack item, Hat hat) {
        ...
        if (size == 1) {
            ...
            description = desc.replace(
                            "{1}",
                            methods.get(MathUtil.wrap(index - 1, size, 0)).getDisplayName())
    ...
    public static void updateParticleDescription(ItemStack item, Hat hat, int particleIndex) {
        ...
        switch (property) {
            ...
            case BLOCK_DATA: {
                ...
                String name =
                        StringUtil.capitalizeFirstLetter(i.getType().toString().toLowerCase());
                if (CosmeticsOG.serverVersion < 13) {
                    name += " [" + Short.toString(i.getDurability()) + "]";
                }

                String description = isBlock
                        ? Message.EDITOR_PARTICLE_BLOCK_DESCRIPTION.getValue()
                        : Message.EDITOR_PARTICLE_ITEM_DESCRIPTION.getValue();
                // String name = isBlock ? hat.getParticleBlock(particleIndex).getType().toString() :
    ...
    public static void updateHatDescription(ItemStack item, Hat hat, boolean isHat) {
        ...
        if (hat.getLeftClickAction() == ParticleAction.EQUIP || hat.getRightClickAction() == ParticleAction.EQUIP) {
            ...
            String type = hat.getType().isCustom()
                    ? hat.getCustomEffect().getImageDisplayName()
            ...
            description.add(frequencyDesc
                    .replace("{1}", Integer.toString(hat.getUpdateFrequency()))
        ...
        if (isHat) {
            ...
            switch (leftAction) {
                case COMMAND:
                    String command = Message.EDITOR_HAT_COMMAND_DESCRIPTION
                            .getValue()
                            .replace("{1}", hat.getLeftClickArgument());
                ...
                case OPEN_MENU:
                    String menu =
                            Message.EDITOR_HAT_MENU_DESCRIPTION.getValue().replace("{1}", hat.getLeftClickArgument());
                ...
                case DEMO:
                    ...
                    String durationDesc =
                            Message.EDITOR_HAT_DURATION_DESCRIPTION.getValue().replace("{1}", formattedTime);
            ...
            switch (rightAction) {
                case COMMAND:
                    String command = Message.EDITOR_HAT_COMMAND_DESCRIPTION
                            .getValue()
                            .replace("{1}", hat.getRightClickArgument());
                ...
                case OPEN_MENU:
                    String menu =
                            Message.EDITOR_HAT_MENU_DESCRIPTION.getValue().replace("{1}", hat.getRightClickArgument());
        ...
        // Convert the List<Component> to List<String> using legacySerializerAnyCase and add to description.
        List<Component> footerDescription =
                StringUtil.parseDescription(Message.EDITOR_HAT_FOOTER_DESCRIPTION.getValue());
        List<String> footerStrings = footerDescription.stream()
                .map(component ->
                        Utils.legacySerializerAnyCase(component.toString()).content())
    ...
    public static void updatePotionDescription(ItemStack item, PotionEffect pe) {
        ...
        String name = pe != null
                ? StringUtil.capitalizeFirstLetter(pe.getType().getName().toLowerCase())
                : typeInfo[1];
