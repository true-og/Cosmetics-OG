    ...
    public void onMetaSet(EditorMenuManager editorManager, Player player, List<String> args) {
        ...
        switch (this) {
            ...
            case NEW_MENU:
                {
                    String menuName =
                            (rawString.contains(".") ? rawString.split("\\.")[0] : rawString).replaceAll(" ", "_");
            ...
            case HAT_NAME:
                {
                    ...
                    editorManager
                            .getEditingMenu()
                            .onHatNameChange(editorManager.getBaseHat(), editorManager.getTargetSlot());
                    editorManager.reopen();
                }
                break;
            ...
            case HAT_LABEL:
                {
                    ...
                    core.getDatabase()
                            .onLabelChange(targetHat.getLabel(), label, targetHat.getMenu(), targetHat.getSlot());
            ...
            case HAT_PERMISSION_DESCRIPTION:
                {
                    ...
                    List<String> description =
                            this == HAT_DESCRIPTION ? targetHat.getDescription() : targetHat.getPermissionDescription();
