...
public enum MetaState {
    ...
    NONE, HAT_NAME, HAT_LABEL, HAT_COMMAND, HAT_DESCRIPTION, HAT_PERMISSION, HAT_PERMISSION_DESCRIPTION,
    HAT_PERMISSION_MESSAGE, HAT_EQUIP_MESSAGE, HAT_TAG, MENU_TITLE, MENU_ALIAS, NEW_MENU, BLOCK_SEARCH, NPC_MANAGE;
     ...
     * 
     * @return The description of this mode as defined in the current messages.yml
     *         file
     */
    ...
    public void onMetaSet(EditorMenuManager editorManager, Player player, List<String> args) {
        ...
        /**
         * Solution for adding empty spaces: Find any %_% value and replace all _'s
         * inside with " "
         */
        ...
        switch (this) {
            ...
            case NEW_MENU: {
                ...
                String menuName = (rawString.contains(".") ? rawString.split("\\.")[0] : rawString).replaceAll(" ",
                        "_");
            ...
            case HAT_NAME: {
                ...
                editorManager.getEditingMenu().onHatNameChange(editorManager.getBaseHat(),
                        editorManager.getTargetSlot());
                editorManager.reopen();
            ...
            case HAT_PERMISSION_DESCRIPTION: {
                ...
                List<String> description = this == HAT_DESCRIPTION ? targetHat.getDescription()
                        : targetHat.getPermissionDescription();
