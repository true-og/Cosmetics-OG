				...
				if (config.contains(path + "particle"))
				{
					...
					case BLOCK_DATA:
					{
						...
						else
						{
							...
							ItemStack block = ItemUtil.createItem(material, 1, (short) config.getInt(path + "block-data.damage-value"));
					...
					case ITEM_DATA:
					{
						...
						else
						{
							...
							ItemStack item = ItemUtil.createItem(material, 1, config.getInt(path + "item-data.damage-value"));
