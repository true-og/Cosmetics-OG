...
public class EntityListener implements Listener {
    ...
    public EntityListener(final CosmeticsOG core) {
    ...
    /**
     * Prevents item from being picked up if they were created from the ItemStack
     * particle effect
     * 
     * @param event
     */
    ...
    private void handleCombat(Entity entity) {
        ...
        // We don't want to create a new EntityState if one doesn't exist for this
        // entity
