...
public enum ParticleType {
    ...
    NONE(0, new PlaceholderEffect()), HALO(1, new HaloEffect()), TRAIL(2, new TrailEffect()), CAPE(3, new CapeEffect()),
    WINGS(4, new WingsEffect()), VORTEX(5, new VortexEffect()), ARCH(6, new ArchEffect()), ATOM(7, new AtomEffect()),
    SPHERE(8, new SphereEffect()), CRYSTAL(9, new CrystalEffect()), HELIX(10, new HelixEffect()),
    INVERSE_VORTEX(11, new InverseVortexEffect()), HOOP(12, new HoopEffect()), SUSANOO(13, new SusanooEffect()),
