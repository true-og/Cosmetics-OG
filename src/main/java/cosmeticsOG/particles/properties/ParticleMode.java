...
public enum ParticleMode {
    ...
    ACTIVE(0, -1), WHEN_MOVING(1, -1), WHEN_AFK(2, -1), WHEN_PEACEFUL(3, -1), WHEN_GLIDING(4, 9), WHEN_SPRINTING(5, -1),
    WHEN_SWIMMING(6, 13), WHEN_FLYING(7, -1);
    ...
    public boolean isSupported() {
        ...
        return CosmeticsOG.serverVersion >= supportedVersion;
