...
public class IconData {
    ...
    private static final ItemStack tempMainItem = ItemUtil.createItem(CompatibleMaterial.SUNFLOWER.getMaterial(), 1, 0);
    ...
    /**
     * Represents a stripped down version of an ItemStack, containing only the
