package cosmeticsOG.particles.renderer.legacy;
...
import cosmeticsOG.particles.renderer.legacy.ReflectionUtils.PackageType;
...
public class LegacyParticleRenderer implements ParticleRenderer {
    ...
    @Override
    public <T> void spawnParticle(World world, ParticleEffect particle, Location location, int count, double offsetX,
    ...
    public static final class ParticlePacket {
         ...
         * @see #initialize()
         */
        public ParticlePacket(ParticleEffect effect, double offsetX, double offsetY, double offsetZ, double speed,
         ...
         */
        public ParticlePacket(ParticleEffect effect, Vector direction, double speed, boolean longDistance,
        ...
        public ParticlePacket(ParticleEffect effect, Color color, boolean longDistance) {
            ...
            this(effect, ((float) color.getRed() / 255f), ((float) color.getGreen() / 255f),
                    ((float) color.getBlue() / 255f), 1, 0, longDistance, null);
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                throw new VersionIncompatibleException(
                        "Your current bukkit version seems to be incompatible with this library, version: " + version
                                + "server: " + PackageType.getServerVersion(),
                        exception);
