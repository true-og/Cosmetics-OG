...
public class Hat {
    ...
    private String name = Message.EDITOR_MISC_NEW_PARTICLE.getValue();
    ...
    private List<@NotNull String> normalDescription;
    private List<@NotNull String> permissionDescription;
    private List<@NotNull String> cachedDescription;
    ...
    private ItemStack item = CompatibleMaterial.SUNFLOWER.getItem(1);
    ...
    public Hat() {
        ...
        normalDescription = new ArrayList<@NotNull String>();
        permissionDescription = new ArrayList<@NotNull String>();
        cachedDescription = new ArrayList<@NotNull String>();
    ...
    /**
     * Set this hats permission. Only include the last section of the permission
     * value.
     * 
     ...
     * 
     * @return message players will receive when they don't have permission to use
     *         this hat
     */
    ...
    /**
     * Set the left / right click action argument depending on the editing action
     * value
     * 
     * @param argument
     */
     ...
     * Get this hats ParticleTracking method
     * 
     * @return A tracking method that may or may not be compatible with this hats
     *         Type
     */
    ...
    /**
     * Returns whether this hat was loaded Lets us know if we need to load this hat
     * from our database
     * 
     * @return
     */
     ...
     * 
     * @param updateFrequency How often this hat displays particles, <B>1 =
     *                        fastest</b>
     */
    ...
    public void setDescription(List<String> description) {
        ...
        List<Component> cachedDescription = new ArrayList<>();
        for (String line : description) {

            cachedDescription.add(Component.text(line));
    ...
    /**
     * Set the description players will see if they don't have permission to equip
     * this hat
     * 
     * @param description
     */
    public void setPermissionDescription(List<@NotNull String> description) {
    ...
    /**
     * Get the description players will see if they don't have permission to equip
     * this hat
     * 
     * @return
     */
    public List<@NotNull String> getPermissionDescription() {
    ...
    /**
     * Get this menus cached description. Cached description contains the raw
     * description info before being translated
     * 
     * @return
     */
    public List<@NotNull String> getCachedDescription() {
    ...
    /**
     * Compares each nodes index value to the given index value and returns the
     * matching node<br>
    ...
    /**
     * Gets the first displayable ParticleEffect this hat has, or NONE is nothing is
     * found
     * 
     * @return
     */
    ...
    /**
     * Check to see if this Hat can be equipped.
     * 
     * @return
     */
    ...
    /**
     * Handles any necessary actions that need to take place when this hat is
     * equipped
     * 
     * @param player
     */
    ...
    /**
     * Returns a copy of this object with only data necessary for displaying
     * particles
     * 
     * @return
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!hat.menu.equals(menu))
            return false;
        if (hat.slot != slot)
            return false;
        if (!hat.permission.equals(permission))
            return false;
        if (!hat.getType().equals(type))
            return false;
        if (!hat.getLocation().equals(location))
            return false;
        if (!hat.getMode().equals(mode))
            return false;
        if (!hat.getAnimation().equals(animation))
            return false;
        if (!hat.getTrackingMethod().equals(trackingMethod))
            return false;
        if (!hat.getOffset().equals(offset))
            return false;
        if (!hat.getRandomOffset().equals(randomOffset))
            return false;
        if (!hat.getAngle().equals(angle))
            return false;

        if (hat.getCustomEffect() != null) {

            if (!hat.getCustomEffect().equals(customEffect))
                return false;
        ...
        if (hat.getCount() != count)
            return false;
        if (hat.getSpeed() != speed)
            return false;
        if (!hat.getLabel().equals(label))
            return false;
        if (!hat.getLeftClickAction().equals(leftAction))
            return false;
        if (!hat.getRightClickAction().equals(rightAction))
            return false;

        if (!hat.getLeftClickArgument().equals(leftClickArgument))
            return false;
        if (!hat.getRightClickArgument().equals(rightClickArgument))
            return false;

        if (hat.getPotion() != null) {

            if (!hat.getPotion().equals(potion))
                return false;
