...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public List<String> onTabComplete(
            CommandSender commandSender, org.bukkit.command.Command cmd, String label, String[] args) {
        Sender sender = new Sender(commandSender);

        List<String> arguments =
                mainCommand.onTabComplete(core, sender, label, new ArrayList<String>(Arrays.asList(args)));
    ...
    public boolean onCommand(CommandSender commandSender, org.bukkit.command.Command cmd, String label, String[] args) {
        return mainCommand.onCommand(
                core, new Sender(commandSender), label, new ArrayList<String>(Arrays.asList(args)));
    }
