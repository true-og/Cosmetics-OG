...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    @Override
    public List<String> onTabComplete(CommandSender commandSender, org.bukkit.command.Command cmd, String label,
            String[] args)
    {

        Sender sender = new Sender(commandSender);

        List<String> arguments = mainCommand.onTabComplete(core, sender, label,
    ...
    public boolean onCommand(CommandSender commandSender, org.bukkit.command.Command cmd, String label, String[] args) {
        ...
        return mainCommand.onCommand(core, new Sender(commandSender), label,
                new ArrayList<String>(Arrays.asList(args)));
    ...
    private List<String> sortCommandSuggestions(List<String> commands, String currentCommand) {
        ...
        if (commands != null) {
            ...
            commandLoop: for (String s : commands) {
