...
- Selectively removed un-used particles.
- Updated en_US.lang with missing particle descriptions.
- Removed unbuildable dependencies.
- Restructured project root.
- Inserted custom config files.
